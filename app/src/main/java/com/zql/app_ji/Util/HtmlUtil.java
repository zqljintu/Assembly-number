...
public class HtmlUtil {
     ...
     * 生成完整的HTML文档
     */
    public static String createHtmlData(String html, List<String> cssList, List<String> jsList,boolean night) {
        String css;
        if (night){
            css = HtmlUtil.createCssTag(cssList)+ "</head><body class=\"night\">";
        }else {
            css = HtmlUtil.createCssTag(cssList);
        }
